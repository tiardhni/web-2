...
<form method="POST" action="hasil-form-regis.php" class="container mt-5">
    <fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
        ...
        <input id="nim" name="nim" placeholder="*0110124202" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Tia Ramadhani" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
        ...
        foreach($ar_skill as $nama => $nilai) {
            ...
            echo "<input name='skill[]' id='skill_$nama' type='checkbox' class='custom-control-input' value='$nama'>";
            echo "<label for='skill_$nama' class='custom-control-label'>$nama</label>";
            echo "</div>";
        }
        ?>
    </div>
