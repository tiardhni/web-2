                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="create-user.php" method="POST">
                                <div class="mb-3">
                                    <label for="firstname" class="form-label.php">First Name</label>
                                    <input type="text" class="form-control" id="firstname" name="firstname" required>
                                </div>
                                <div class="mb-3">
                                    <label for="lastname" class="form-label.php">Last Name</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label for="laki-laki" class="form-check-label">Perempuan</label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="age" class="form-label.php">Age</label>
                                        <input type="number" class="form-control" id="age" name="age" min="0" max="100" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="weight" class="form-label.php">Weight</label>
