            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-user.php">Dashboard</a></li>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="edit-user.php?id=<?= $user['id'] ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="age" class="form-label d-block">Age</label>
                                <input type="number" class="form-control" id="age" name="age" min="0" max="100" value="<?= $user['age'] ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="weight" class="form-label d-block">Weight</label>
