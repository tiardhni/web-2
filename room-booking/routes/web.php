...
Route::get('/unit-kerja/{unitKerja}/edit', EditUnitKerja::class)->name('unit-kerja.edit');
...
Route::get('/peminjaman/{peminjaman}/edit', EditPeminjaman::class)->name('peminjaman.edit');